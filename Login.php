            ...
            <tr>
                <td colspan="2" class="sign-up-table">
                    <div class="" style="margin:20px;">
                        <input type="submit" name="btnSignUpDriver" class="button" value="Sign Up" style="color:white; font-weight:bold;" id="btnSignUpDriver" onclick="JavaScript:return validateSignupDriverForm();">
                    </div>
                    <div class="hr">
					</div>
                    <div class="foot">
        ...
        <table>
			...
			<tr>
				<td class="sign-up-table">
					<!--nic-->
					<div class="">
						<input name="nicRDA" id="txtNICRDA" type="text" class="form-control" placeholder="Enter your NIC">
					</div>
				</td>
			...
			<tr>
		     <td colspan="2" class="sign-up-table">
					<div class="group" style="margin:20px;">
						<input type="submit" name="btnSignUpRDA" class="button" value="Sign Up" style="color:white; font-weight:bold;" id="btnSignUpRDA" onclick="JavaScript:return validateSignupRDAForm();">
					</div>
					<div class="hr">
					</div>
					<div class="foot">
  ...
  <div class="sub-tab-content">
    <table>
		...
		<td class="sign-up-table">
                    <!--pass-->
                    <div class="">
                        <input name="pwPolice" id="txtSignUpPasswordPolice" type="password" class="form-control" data-type="password" placeholder="Create your password">
                    </div>
                </td>
			 ...
			 <td class="sign-up-table">
                    <!--rep pass-->
                    <div class="">
                        <input name="reppwPolice" id="txtSignUpRepPassPolice" type="password" class="form-control" data-type="password" placeholder="Repeat your password">
                    </div>
                </td>
			</tr>
		<tr>
